...
The API key goes in `secrets/TEXT_API_KEY`, not in .env.
...
Vision key goes in `secrets/VISION_API_KEY`.
...
The phone talks directly to your Docker container over LAN. No cloud.
